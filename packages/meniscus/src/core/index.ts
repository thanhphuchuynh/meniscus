...
export { GlassPhysics, OPTICAL_REST, RESPONSE, presenceOpacity, staggerDelay, type OpticalChannel, type OpticalState, type GlassPhysicsOptions, type TransitionOptions } from './physics';
